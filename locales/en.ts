const en = {
  ...
  offerForm: {
    ...
    fields: {
      ...
      categoriesHint: 'Optional',
      othersCategory: 'Specify other category',
      expireAfter: 'Auto-expire after',
    ...
    placeholders: {
      title: 'Add a headline for your offer',
      othersCategory: 'e.g. Hidden gems',
      expireAfter: 'Select expiration',
      visibility: 'Select visibility',
      content: 'Write your offer here...',
    },
    helpers: {
      mediaRequired: 'One of image, video, or content required',
      videoFormats: 'MP4 or MOV up to 50MB',
      chooseVideo: 'Choose video from library',
    ...
    validation: {
      ...
      contentOrMediaRequired:
        'Add an image, a video, or write something in the content area.',
      contentMaxLength: 'Content must be at most {{max}} characters.',
      expireRequired: 'Please choose when this offer expires.',
      visibilityRequired: 'Please choose who can see this offer.',
      othersNameRequired: "Please specify the 'Others' category name.",
      businessRequired: 'Select a business before creating an offer.',
    },
    success: 'Offer published!',
    error: 'Could not publish offer.',
    mediaError: 'Offer created, but media upload failed.',
  },
  preHomeOnboarding: {
    skip: 'Skip',
    step1: {
